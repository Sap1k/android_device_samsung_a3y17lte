...
# cpboot-daemon
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/rootdir/sbin/cbd:$(TARGET_COPY_OUT_VENDOR)/bin/cbd

# sswap
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/rootdir/sbin/sswap:$(TARGET_COPY_OUT_VENDOR)/bin/sswap
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/wifi/android.hardware.wifi@1.0-service.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/android.hardware.wifi@1.0-service.rc